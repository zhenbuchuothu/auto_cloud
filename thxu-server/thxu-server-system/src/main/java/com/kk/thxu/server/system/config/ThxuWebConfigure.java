...
import com.kk.thxu.server.system.properties.ThxuSwaggerProperties;
...
public class ThxuWebConfigure {
    ...
    public Docket swaggerApi() {
        ThxuSwaggerProperties swagger = properties.getSwagger();
    ...
    private ApiInfo apiInfo(ThxuSwaggerProperties swagger) {
        return new ApiInfo(
                swagger.getTitle(),
    ...
    private SecurityScheme securityScheme(ThxuSwaggerProperties swagger) {
    ...
    private SecurityContext securityContext(ThxuSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(ThxuSwaggerProperties swagger) {
