...
import com.kk.thxu.gateway.fallback.ThxuGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class ThxuGatewaySentinelFilter {
    @Bean
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new ThxuGatewayBlockFallbackProvider());
